...
tags:
  - 技术
  - 前端
slug: 2025-08-08-前端开发-三
collection: technical_talk
summary: "Vue3的脚手架构建\r \r Vue的安装与模板创建\r \r vue的安装与简单的模板创建方式如下：\r \r \r \r 使用Vite创建项目\r \r 创建Vite项目的方式包括Create Vite、Create Vue、Create Preset三种：\r \r \r \r 不论使用上方哪种方式"
related_nodes: []
---
# Vue3的脚手架构建
