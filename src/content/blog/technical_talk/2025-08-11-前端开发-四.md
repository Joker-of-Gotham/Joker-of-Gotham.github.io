...
cover: /assets/img/covers/孤独摇滚-虹夏2.webp
categories:
  - 技术杂谈
tags:
  - 技术
  - 前端
slug: 2025-08-11-前端开发-四
collection: technical_talk
summary: "路由的使用\r \r 路由的目录结构\r \r Vue3的路由管理在的目录下：\r \r \r \r index.ts 是路由的入口文件，如果路由很少，那么可以只维护在这个文件里；项目稍微复杂时，可以拆出两个文件index.ts 和 routes.ts ，在 routes.ts 里维护路由树的结"
related_nodes: []
---
# 路由的使用
