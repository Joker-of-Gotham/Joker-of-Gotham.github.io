...
cover: /assets/img/covers/孤独摇滚-山田凉.webp
categories:
  - 技术杂谈
tags:
  - 技术
  - 前端
slug: 2025-08-05-前端开发-一
collection: technical_talk
summary: "前端工程化\r \r 前端工程化需要遵循的一些规范\r \r 前端工程化代码的常用结构：\r \r \r \r 在写属性时，尽可能一个属性占一行；同时对多种正确的语法方式要确定一种作为标准\r \r Vue.js与工程化\r \r Vue 的编程方式被称为 “数据驱动” 编程，通过操作虚拟 DOM （ "
related_nodes: []
---
# 前端工程化
