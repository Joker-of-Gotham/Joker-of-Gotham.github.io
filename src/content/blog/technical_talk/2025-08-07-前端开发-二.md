...
tags:
  - 技术
  - 前端
slug: 2025-08-07-前端开发-二
collection: technical_talk
summary: "TypeScript简介和需求原因\r \r TypeScript 简称 TS ，是在 JavaScript 的基础上增加了一套类型系统，它支持所有的 JS 语句，为工程化开发而生，最终在编译的时候去掉类型和特有的语法，生成 JS 代码。\r \r 对于下述JavaScript代码：\r "
related_nodes: []
---
# TypeScript简介和需求原因
