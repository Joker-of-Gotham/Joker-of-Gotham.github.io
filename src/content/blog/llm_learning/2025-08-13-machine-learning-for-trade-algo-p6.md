...
cover: /assets/img/covers/GBC-五人合照.webp
categories:
  - 人工智能
  - 机器学习
tags:
  - 综述笔记
  - 金融量化
slug: 2025-08-13-machine-learning-for-trade-algo-p6
collection: llm_learning
summary: "用于交易的深度学习\r \r 作为表征学习的深度学习\r \r 许多⼈⼯智能任务，如图像或语⾳识别，都需要关于世界的知识。其中⼀个关键挑战是如何对这些知识进⾏编码，以便计算机能够利⽤它们。⼏⼗年来，开发机器学习系统需要⼤量的领域专业知识，才能将原始数据（如图像像素）转换为学习算法可以⽤来"
related_nodes: []
---
# 用于交易的深度学习
