...
tags:
  - 综述笔记
  - 金融量化
slug: 2025-08-13-machine-learning-for-trade-algo-p5
collection: llm_learning
summary: "⽆监督学习实现数据驱动的⻛险因⼦和资产配置\r \r ⽆监督学习通过学习⼀种信息丰富的数据表示，帮助探索新数据、发现有⽤的⻅解或更有效地解决其他任务。降维和聚类是⽆监督学习的主要任务。\r \r 维度灾难\r \r 由距离公式：\r \r $$d(p,q)=\\sqrt{\\sum\\limits_{"
related_nodes: []
---
