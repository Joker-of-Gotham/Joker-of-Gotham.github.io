...
tags:
  - 综述笔记
  - 金融量化
slug: 2025-08-13-machine-learning-for-trade-algo-p4
collection: llm_learning
summary: "⽤于波动率预测和统计套利的时间序列模型\r \r 本部分，我们将构建动态线性模型，以明确表示时间，并纳⼊在特定时间间隔或滞后期观测到的变量。时间序列数据的⼀个关键特征是其序列顺序：我们的数据不是像横截⾯数据那样的单个观测值的随机样本，⽽是⼀个我们⽆法重复的随机过程的单次实现。我们的⽬"
related_nodes: []
---
# ⽤于波动率预测和统计套利的时间序列模型
