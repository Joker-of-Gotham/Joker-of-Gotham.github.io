...
tags:
  - 综述笔记
  - 金融量化
slug: 2025-08-05-machine-learning-for-trade-algo-p1
collection: llm_learning
summary: "机器学习在算法交易中的发展潮流\r \r 量化投资与因子制取方法的发展\r \r 随着交易不断的高频化和隐藏化，为了在混乱的交易中脱颖而出，则需要研究更加优秀的算法；同时，由于交易和风险紧密相连，风险因子的探究也变得愈发重要，从单因子逐渐演变为了双因子。\r \r 在重视程度方面，基本面投资"
related_nodes: []
---
# 机器学习在算法交易中的发展潮流
