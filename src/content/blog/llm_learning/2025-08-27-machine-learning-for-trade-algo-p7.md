...
tags:
  - 综述笔记
  - 金融量化
slug: 2025-08-27-machine-learning-for-trade-algo-p7
collection: llm_learning
summary: "Alpha 类型分类总览\r \r 均值回归型(Mean-Reversion Alpha)\r \r alpha 的方向与其所基于的回报方向相反——例如当价格上涨时做空，价格下跌时做多，预期价格将“回归”。示例如下：\r \r $$\\alpha= - \\ln (\\frac{\\text{tod"
related_nodes: []
---
# Alpha 类型分类总览
