...
tags:
  - 综述笔记
slug: 2025-07-18-reinforcement-learning
collection: llm_learning
summary: "强化学习的数学基础\r \r 基本概念\r \r 强化学习的基础概名词\r \r - **状态(State)**：表示当下环境，是做决策的唯一依据\r - **动作(Action)**：做出的决策，动作种数一般用$i$表示\r - **环境(Environment)**：使智能体不断变换状态的位"
related_nodes:
  - llm-systems-track
related_artifacts:
