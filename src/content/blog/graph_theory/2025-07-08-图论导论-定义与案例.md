...
cover: /assets/img/covers/四月是你的谎言-薰2.webp
categories:
  - 数学
  - 图论
tags:
  - 定义
  - 核心概念
slug: 2025-07-08-图论导论-定义与案例
collection: graph_theory
summary: "图的定义与基础概念\r \r **图的组成**：节点集[V(G)]，边集[E(G)]\r \r \r \r 图的重构(Isomophism)\r \r 图的重构可以采用如下的数学逻辑描述：\r \r $$ for \\ G_1 \\ and \\ G_2, E_1(G) \\leftrightarrow E"
related_nodes: []
---
## 图的定义与基础概念
