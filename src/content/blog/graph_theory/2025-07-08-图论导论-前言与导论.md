...
cover: /assets/img/covers/四月是你的谎言-薰.webp
categories:
  - 数学
  - 图论
tags:
  - 导入
  - 指引
slug: 2025-07-08-图论导论-前言与导论
collection: graph_theory
summary: "书籍内容分布\r \r 该书一共可分为四个部分：\r \r * **第1-3章**：基础知识，包括图、有向图、连通性、欧拉和哈密顿路径、循环、树\r * **第4-5章**：平面和着色，重点介绍四色定理\r * **第6章**：横向理论和连通性\r * **第7章**：拟阵\r \r 图(grap"
related_nodes: []
---
## 书籍内容分布
