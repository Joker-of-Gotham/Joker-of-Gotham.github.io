...
6. Name the result a **multi-pose 2.5D actor**. Do not claim Live2D or skeletal 3D. A true layered/rigged model requires a separate art, licence and dependency decision.
